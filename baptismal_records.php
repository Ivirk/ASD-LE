...
$stmt = $conn->prepare("SELECT * FROM BaptismalRecords WHERE full_name LIKE ? ORDER BY date_baptism DESC");
    ...
    <div class="main">
        ...
        <div class="records-section">
            <div class="records-header">
                <h3 class="records-title">Baptismal Records</h3>
            </div>

            <?php if ($result->num_rows > 0): ?>
                <?php while ($row = $result->fetch_assoc()): ?>
                    <div class="record">
                        <h4><?= htmlspecialchars($row['full_name']) ?> – <?= htmlspecialchars($row['date_baptism']) ?></h4>
                        <p>Place: <?= htmlspecialchars($row['place_baptism']) ?></p>
                ...
                <?php endwhile; ?>
            <?php else: ?>
                <p>No baptismal records found.</p>
            <?php endif; ?>
        </div>
    </div>
